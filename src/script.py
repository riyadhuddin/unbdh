...
def generate_data_transformation_config():
    ...
    column_group_3 = ['price']
    
    column_group_0 = ['date']
    
    column_group_2 = ['priceflag', 'pricetype']
    
    column_group_1 = ['admin1', 'admin2', 'market', 'latitude', 'longitude', 'category', 'commodity', 'unit']
...
if __name__ == '__main__':
    ...
    parser.add_argument('--training_dataset_id', type=str, default='1e0288af-938c-479c-865a-e4bb6e47eb20',     help='Default training dataset id is populated from the parent run')
